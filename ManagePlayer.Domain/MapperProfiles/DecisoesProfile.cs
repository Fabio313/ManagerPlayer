    ...
    public class DecisoesProfile : Profile
    {
        public DecisoesProfile()
        {
            CreateMap<DecisoesDto, Question>()
                ...
                .ForMember(dest => dest.RespostaPositiva, opt => opt.MapFrom(src => ConvertResposta(src.RespostaPositiva)))
                .ForMember(dest => dest.OpcaoNegativa, opt => opt.MapFrom(src => src.OpcaoNegativa))
                .ForMember(dest => dest.RespostaNegativa, opt => opt.MapFrom(src => ConvertResposta(src.RespostaNegativa)));
        }

        public Resposta ConvertResposta(string jsonResposta)
        {
